...
- [x] First-person embodiment — the author is Alice in ALICE and Bob in BOB: visible body looking down (torso, arms, legs; head hidden from the camera), walking/stopping animations, axe in Bob's hand; in the middle of the transition the player teleports to the new reference post and the embodied NPC disappears
